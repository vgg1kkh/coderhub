...
class momentController {
  ...
  async addLables(ctx,nex){
        // const lableAndMomentIds = ctx.lableAndMomentIds
        // console.log("lables=",lables)
        console.log("lableAndMomentIds",lableAndMomentIds)
        /*
        lableAndMomentIds [
  ...
  { momentsId: '1', lableId: 11 }
        ...
        */
        const result = await addLables(ctx.lableAndMomentIds)
