...
const { create,detail,list,update,remove, addLabels } = require("../controller/moments.controller");
...
momentRouter.post('/:momnetId/labels',verifyAuth,verifyPermission,addLabels)
